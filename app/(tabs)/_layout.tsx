...
// Seuls ces 4 onglets ont un bouton dans la barre du bas — les autres
// écrans (decisions, messagerie, finances, documents, journal, caf,
// enfants) restent des routes normales, atteignables via router.push
// depuis "Échanges" et "Famille", mais n'ont pas leur propre bouton.
  ...
  return (
    ...
    >
      <View style={{ flexDirection: 'row', height: 60, alignItems: 'center' }}>
        ...
        {/* Bouton central — ajout rapide, ce n'est pas une route */}
        <TouchableOpacity
...
export default function TabLayout() {
  ...
  return (
    ...
    >
      ...
      {/* Écrans toujours présents, mais sans bouton dans la barre — on y
          accède via "Échanges" ou "Famille". */}
